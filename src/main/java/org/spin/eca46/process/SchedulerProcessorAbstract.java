...
/** Generated Process for (Scheduler Processor)
...
public abstract class SchedulerProcessorAbstract extends SvrProcess {
	...
	protected void prepare() {
		schedulerId = getParameterAsInt(AD_SCHEDULER_ID);
	}

	/**	 Getter Parameter Value for Scheduler	*/
	protected int getSchedulerId() {
		return schedulerId;
	}

	/**	 Setter Parameter Value for Scheduler	*/
	protected void setSchedulerId(int schedulerId) {
